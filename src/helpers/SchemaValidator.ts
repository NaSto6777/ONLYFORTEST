...
const ControlPanelSchema = z.object({
    enabled: z.boolean().default(false),
    port: z.number().int().min(1).max(65535).default(4780),
    runOnStartup: z.boolean().default(true)
})

const AuthSchema = z.object({
    passwordlessTimeoutSeconds: z.number().int().min(30).max(600).default(180)
})
...
export const ConfigSchema = z.object({
    ...
    promotionDelay: DelaySchema.optional(),
    debugLogs: z.boolean(),
    proxy: z.object({
    ...
    controlPanel: ControlPanelSchema.optional(),

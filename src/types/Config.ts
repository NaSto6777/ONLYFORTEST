...
export interface ConfigUpdates {
    /** When false, skip GitHub auto-update checks (overridable with MSRB_AUTO_UPDATE=1). */
    enabled: boolean
    /** GitHub repo as owner/name or full URL, e.g. "your-user/Microsoft-Rewards-Bot". */
    repo?: string
...
export interface ConfigAuth {
    /** Seconds to wait for Microsoft Authenticator approval (default 180). */
    passwordlessTimeoutSeconds: number
}

export interface ConfigControlPanel {
    enabled: boolean
    port: number
